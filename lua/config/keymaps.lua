...
vim.keymap.set("i", "<C-w><Up>", "<Esc><Cmd>resize +2<CR>a")
vim.keymap.set("v", "<C-w><Up>", "<Esc><Cmd>resize +2<CR>gv")
vim.keymap.set("n", "<C-w><Down>", "<Esc><Cmd>resize -2<CR>")
vim.keymap.set("i", "<C-w><Down>", "<Esc><Cmd>resize -2<CR>a")
vim.keymap.set("v", "<C-w><Down>", "<Esc><Cmd>resize -2<CR>gv")
vim.keymap.set("n", "<C-w><Left>", "<Esc><Cmd>vertical resize -2<CR>")
vim.keymap.set("i", "<C-w><Left>", "<Esc><Cmd>vertical resize -2<CR>a")
vim.keymap.set("v", "<C-w><Left>", "<Esc><Cmd>vertical resize -2<CR>gv")
vim.keymap.set("n", "<C-w><Right>", "<Esc><Cmd>vertical resize +2<CR>")
vim.keymap.set("i", "<C-w><Right>", "<Esc><Cmd>vertical resize +2<CR>a")
vim.keymap.set("v", "<C-w><Right>", "<Esc><Cmd>vertical resize +2<CR>gv")
